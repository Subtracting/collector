...
def get_data():
    ...
    unique_subjects = stats_df['subject'].unique()

    return stats_df, agg_subject_df, unique_subjects


def layout(options):

    stats_df, agg_subject_df, unique_subjects = get_data()
